...
const Customization = () => {
	...
	const [modelData, setModelData] = useState<any>([
		...
		{ src: '', color: activeColor, printImageURL: activePrint?.highresurl, activeCategory }
	])
				...
				for (let i = 0; i < modelData.length; i++) {
					...
					switch (activeType) {
						...
						case "top":
							...
							setModelData(modelData)
							if(activePrint){
								modelData[1].printImageURL =  activePrint?.highresurl
							}
							break;
						case "bottom":
							...
							setModelData(modelData)
							if(activePrint){
								modelData[0].printImageURL =  activePrint?.highresurl
							}
							break;
						default:
							modelData[i].color = activeColor;
