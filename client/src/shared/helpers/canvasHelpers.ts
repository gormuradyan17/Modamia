...
export const canvasModelInit = (num: number, modData: any, frontBack: string = "fronts", canvasRef: any, mannequin: any, updatedModelData: any, fromBasket: boolean, scaleCanvas: number = 1) => {
