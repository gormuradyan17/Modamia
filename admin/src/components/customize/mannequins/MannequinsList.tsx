import { BASE_UPLOADS_MANNEQUINS_BACKS_URL, BASE_UPLOADS_MANNEQUINS_FRONTS_URL, BASE_UPLOADS_PRINTS_PREVIEWS_URL, BASE_UPLOADS_URL } from "shared/constants/genericApiRoutes";
